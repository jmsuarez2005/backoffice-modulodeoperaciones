 ...
 * @author jorojas
 */
public class UsuarioProc implements BasicConfig, RCConfig {

    private static Logger log = Logger.getLogger(UsuarioProc.class);
        ...
        if (usuario == null) {
            ...
            if (usuario.getPassword().length() < 32) {
                ...
                try {
                    ...
                    java.util.logging.Logger.getLogger(UsuarioProc.class.getName()).log(Level.SEVERE, null, ex);
                }
