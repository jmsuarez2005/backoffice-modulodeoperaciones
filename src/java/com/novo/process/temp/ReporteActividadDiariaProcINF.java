 ...
 * @author jorojas
 */
public class ReporteActividadDiariaProcINF implements BasicConfig {
    private static Logger log = Logger.getLogger(ReporteActividadDiariaProcINF.class);
    ...
    public ReporteActividadDiariaProcINF(Date date,UsuarioSesion user) {
        this.fecha = date;
        ...
        this.cambioBsDolar = new BigDecimal(ReporteActividadDiariaProcINF.obtenerCambioMoneda(ve)).setScale(2,BigDecimal.ROUND_HALF_EVEN);  
        this.cambioSolesDolar = new BigDecimal(ReporteActividadDiariaProcINF.obtenerCambioMoneda(pe)).setScale(2,BigDecimal.ROUND_HALF_EVEN);
        this.cambioPesosDolar = new BigDecimal(ReporteActividadDiariaProcINF.obtenerCambioMoneda(co)).setScale(2,BigDecimal.ROUND_HALF_EVEN);
    }
    
    public ReporteActividadDiariaProcINF(){
        this.cambioBsDolar = new BigDecimal(ReporteActividadDiariaProcINF.obtenerCambioMoneda(ve)).setScale(2,BigDecimal.ROUND_HALF_EVEN);  
        this.cambioSolesDolar = new BigDecimal(ReporteActividadDiariaProcINF.obtenerCambioMoneda(pe)).setScale(2,BigDecimal.ROUND_HALF_EVEN);
        this.cambioPesosDolar = new BigDecimal(ReporteActividadDiariaProcINF.obtenerCambioMoneda(co)).setScale(2,BigDecimal.ROUND_HALF_EVEN);
    }
    ...
    public void enviarCorreo(){
        ...
        SendMail.sendEmailHtml(smtpServ,this.obtenerRemitentesCorreo(numAdrCO, CO),asuntoMail+" "+ReporteActividadDiariaProcINF.COLOMBIA+" al "+(new SimpleDateFormat("dd/MM/yyyy")).format(this.fecha),mensaje,sender,mailUser,mailPasswd,rutaImg);
        mensaje=this.generarReporteHtmlPais(this.reportePe,PE);
        SendMail.sendEmailHtml(smtpServ,this.obtenerRemitentesCorreo(numAdrPE, PE),asuntoMail+" "+ReporteActividadDiariaProcINF.PERU+" al "+(new SimpleDateFormat("dd/MM/yyyy")).format(this.fecha),mensaje,sender,mailUser,mailPasswd,rutaImg);
        mensaje=this.generarReporteHtmlPais(this.reporteVe,VE);
        SendMail.sendEmailHtml(smtpServ,this.obtenerRemitentesCorreo(numAdrVE, VE),asuntoMail+" "+ReporteActividadDiariaProcINF.VENEZUELA+" al "+(new SimpleDateFormat("dd/MM/yyyy")).format(this.fecha),mensaje,sender,mailUser,mailPasswd,rutaImg);
