 ...
 * @author ggutierrez
 */
public class AjustesDAOINF extends NovoDAO implements BasicConfig, AjustesTransacciones {

    private static Logger log = Logger.getLogger(AjustesDAOINF.class);

    public AjustesDAOINF(String dbproperty, String[] databases, String pais) {
    ...
    public String updateAjustesDAO(String[] idAjustes, String status) {
        ...
        if (dbo.executeQuery(sql) == 0) {
            ...
            dbo.dbClose();
            log.error("Error actualizando el estatus de los ajustes");
            return "error";
        }
...
//                    return "error3" + dni;
    ...
    public String updateEditarAjustesDAO(String[] idAjustes, String monto, String tipoAJusteEditar, String AjusteDesc) {
        ...
        dbo.dbClose();
        log.info("error actualizando el estatus de los ajustes");
        return "error";
    }
