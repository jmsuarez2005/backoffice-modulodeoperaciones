    ...
    <head>
        ...
        <div class="container">
            <div class="content" id="content">
                <h1  style="margin: 0 0 0 0;">Desbloqueo</h1>
                <br/>
                    ...
                    <s:form action="desbloqueo" method="post" enctype="multipart/form-data" theme = "simple">
                        <table class="table" style="width: 100%;">
                            ...
                            <tbody>                                
                                ...
                                <tr>                                    
                                    <td colspan="3" style="text-align:center"  ><s:submit cssClass="btn btn-primary" value="Cargar Archivo" position="center" action= "Uploaddesbloqueo" onclick="openDialogLoading()"/></td>                                   
