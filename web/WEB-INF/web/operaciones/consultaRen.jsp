            ...
            <div class="content" id="content">
                ...
                <s:form theme="simple" namespace="/operaciones" action="buscarrenovacion">       
                    <div class="panel" style="width: 1000px;margin: 0 auto;">
                        ...
                        <tr>                                                                  
                           <td colspan="6" style="text-align:center;"><s:submit cssClass="btn btn-primary" value= "Buscar" action="buscarrenovacion"/></td> 
                        </tr>  
                        </tbody>                            
                        </table>
 <br>
                        <table class="table" style="width: 100%;">
                            <thead>
                                <tr><th colspan="10" style="text-align:center;">Renovacion</th></tr>
                                <tr>
                                    <th style="text-align:center;">DNI</th>
                                    <th style="text-align:center;">Nro_Cuenta</th>  
